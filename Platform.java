...
public class Platform {
	...
	private static String DHOST = "127.0.0.1";
	private static int DPORT = 3022;
	...
	public Platform(int port){
		...
		try{
			...
			System.out.println("Secure connection established from Station Master");
			...
			try{
				...
				line = aes.decrypt(line, secretKey);
				System.out.println("Decrypted Message: "+line);
				System.out.println("Train arriving at "+line.split(" ")[0]);
				System.out.println("Compartment Sequence: "+line.split(" ")[1]);
				out.writeUTF("Train Compartment Sequence Received Successfully");
			}catch(IOException e){
				e.printStackTrace();
				return;
			}
	...
	public static void main(String args[]){
		Platform server = new Platform(3021);
	}
}
